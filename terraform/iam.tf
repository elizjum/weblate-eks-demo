# Cluaster autoscaler IAM configuration
# https://docs.aws.amazon.com/eks/latest/userguide/cluster-autoscaler.html
# -----------------------------------------------------------------------------

module "iam_assumable_eks_cluster_autoscaler" {
...
# ALB ingress controller IAM configuration
# https://docs.aws.amazon.com/eks/latest/userguide/alb-ingress.html
# -----------------------------------------------------------------------------

module "iam_assumable_role_eks_alb_ingress_controller" {
  source                        = "terraform-aws-modules/iam/aws//modules/iam-assumable-role-with-oidc"
  version                       = "~> v2.6.0"
  create_role                   = true
...
resource "aws_iam_policy" "alb_ingress_controller" {
    ...
    description = "EKS Cluster ALB Ingress Controller policy for cluster ${module.eks.cluster_id}"
